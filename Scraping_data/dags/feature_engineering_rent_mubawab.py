...
def preprocess_mubawab_rent() -> pd.DataFrame:
    try:
        data = pd.read_csv('/opt/airflow/dags/scraped_data_rent_mubawab.csv',index_col=0)
    ...
    try:
        ...
        final_df.to_csv('/opt/airflow/dags/processed_scraped_mubawab_rent.csv',index=False)
