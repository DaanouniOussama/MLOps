...
def copy_csv_to_table_rent():
    try:
        ...
        with open(csv_file_path, "r") as file:
            cur.copy_expert(
                """
                COPY Real_Estate_table_avito_location(Title , Real_estate_type , Transaction, Ville , 
                Secteur , Surface_totale , Surface_habitable , Chambres , Salle_bains , Salons , Pieces , 
                Etage, Terrasse , Balcon, Parking , Ascenseur , Securite , Climatisation , Cuisine_equipee , 
