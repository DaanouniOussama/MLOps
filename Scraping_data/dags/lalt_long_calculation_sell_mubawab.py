...
def lati_long_mubawab()->int:
    try:
        logging.info('Loading scraped data ...')
        df = pd.read_csv('/opt/airflow/dags/scraped_data_sell_mubawab.csv',index_col=0)
    ...
    try:
        ...
        maps_data.to_csv('/opt/airflow/dags/long_lalt_sell_mubawab.csv',index=False, sep=';')
